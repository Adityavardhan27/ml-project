...
# Normalize
df["StatScore"] = (df["StatScore"] - df["StatScore"].min()) / (df["StatScore"].max() - df["StatScore"].min())
df["TempScore"] = (df["TempScore"] - df["TempScore"].min()) / (df["TempScore"].max() - df["TempScore"].min())
